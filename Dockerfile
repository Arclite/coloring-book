...
RUN cp "$(swift build --package-path /build -c release --show-bin-path)/ColoringBookServer" ./
...
LABEL org.opencontainers.image.source=https://github.com/cocoatype/ColoringBook
LABEL org.opencontainers.image.description="The ColoringBook backend server"
